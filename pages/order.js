        ...
        <div className="container px-5 py-24 mx-auto">
          <div className="lg:w-4/5 mx-auto flex flex-wrap">
            <div className="lg:w-1/2 w-full lg:pr-10 lg:py-6 mb-6 lg:mb-0">
              <h2 className="text-sm title-font text-gray-500 tracking-widest">Sellanywhere.in</h2>
              <h1 className="text-gray-900 text-3xl title-font font-medium mb-4">Order Id: #86562562</h1>
              ...
              <div className="flex border-gray-200 border-b-2">
                ...
                <span className="ml-auto text-gray-900">₹499.0</span>
              </div>
              <div className="flex border-gray-200 border-b-2">
                <span className="text-gray-500">Tshirt</span>
                <span className="ml-auto text-gray-500">1</span>
              ...
              <div className="flex mt-4">
                <span className="title-font font-medium text-2xl text-gray-900">Subtotal ₹499.0</span>
